...
# Configurations
parser = argparse.ArgumentParser(description='RL algorithms with PyTorch in Pusher environment')
...
def main():
    ...
    for i in range(args.iterations):
        ...
        if args.phase == 'train':
            ...
            #get out
            final_out.append(train_episode_return)
            ...
            #get total steps
            final_steps.append(train_num_steps)
